    ...
    return [
      {
        ...
        function: {
          ...
          description:
            'Use this tool to record or update user information incrementally. Call this whenever the user provides their name, email, or any other relevant information. You can call this multiple times as the user reveals more details during the conversation.',
          parameters: {
            type: 'object',
            properties: {
              email: {
...
IMPORTANT: Use the record_user_details tool incrementally throughout the conversation:
- When the user provides their name, call record_user_details with just the name
- When the user provides their email, call record_user_details with just the email
...
${this.memory}
My email for future contact is: ${process.env.EMAIL}
